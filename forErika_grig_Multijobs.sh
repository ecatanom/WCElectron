...
export OutDir=/lbne/data2/users/ecatanom/081514_eminus400_50kton_13per_01ns
...
# moving and finally copying output file to your /nova/data area
 ...
 echo '${CPN} ${_CONDOR_SCRATCH_DIR}/output/'"$outFile"' /lbne/data2/users/ecatanom/081514_eminus400_50kton_13per_01ns/' >> $jobcmd
