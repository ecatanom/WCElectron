...
export OutDir=/lbne/data2/users/ecatanom/071714_eminus400_50kton_01ns
...
# moving and finally copying output file to your /nova/data area
 ...
 echo '${CPN} ${_CONDOR_SCRATCH_DIR}/output/'"$outFile"' /lbne/data2/users/ecatanom/071714_eminus400_50kton_01ns/' >> $jobcmd
