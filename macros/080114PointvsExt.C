{
  ...
  //1.2 GeV electron
  //string namefile="addedFiles_electron_200kton_13percCov_0p1ns";
  //string namefile="addedFiles_electron_200kton_13percCov_0p25ns";
  //string namefile= "041514_eminus_200kton_13per_05ns";
  //string namefile="addedFiles_electron_200kton_13percCov_1p0ns";
  //string namefile = "eminus_200kton_13per_MuSct_1p5";
  //string namefile = "eminus_200kton_13per_MuSct_2p0";


  //string namefile = "050414_eminus400_200kton_13per_025ns_temp2";
  //string namefile = "addedFiles_electron_400MeV_200kton_13percCov_0p1ns";

  // 400 MeV electron
  //  string namefile = "050714_eminus400_200kton_13per_01ns_16neig";
  //string namefile = "062014_eminus400_50kton_13per_01ns";
  ...
  TChain* RecoChain = new TChain("ntuple","chain");
   ...
   RecoChain->Add(("/lbne/data2/users/ecatanom/electrONntuples/"+namefile+".root").c_str());
  //RecoChain->Add(("/lbne/data2/users/txin/FitResult/"+namefile+".root").c_str());
  ...
  for( Int_t i=0; i<RecoChain->GetEntries(); i++ ){
	...
	if(foundVertex){
	  ...
	  if(extendedVtxPass==1){
	    ...
	    // cout<< "PASSED" << eventNum << " total "<< ds5  << endl;
