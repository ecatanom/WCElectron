{
  ...
  string namefile = "electron_200kton_13percCov_0p25ns/test_eleFunc_myMod2"; //lmuon300
  ...
  RecoChain->Add(("/lbne/data2/users/omanghel/"+namefile+".root").c_str());
  ...
  Double_t radius = 3112.95; //4202.59 for 500 kton
  Double_t height = 3999.05; //5206.05 for 500 kton
  Int_t aaa = 0;
  Int_t bbb = 0;
  Int_t ccc = 0;
...
*/
	  ...
	  //testconh->Fill(ds5*sinth5); // perpend 
